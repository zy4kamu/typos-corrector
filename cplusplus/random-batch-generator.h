...
public:
    ...
    int32_t generate_random_batch_on_one_ur(int32_t* clean_batch, int32_t* contaminated_batch, size_t batch_size);
    void generate_random_batch_on_all_urs(int32_t* clean_batch, int32_t* contaminated_batch, size_t batch_size);
private:
