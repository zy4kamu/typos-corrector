...
if __name__ == '__main__':
    ...
    parser.add_argument('-b', '--batch-size',   type=int, help='number of tokens in batch',     default=64)
    ...
    update_region_id, clean, contaminated = cpp_bindings.generate_random_batch(args.batch_size, args.message_size)
